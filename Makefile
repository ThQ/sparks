...
example-bars:
	$(xCC_EXAMPLE) -O0 examples/bars.c -o ./build/sparks-bars

example-multi-line:
	$(xCC_EXAMPLE) -O0 examples/multi_line.c .build/sparks-multi-line

example-line-area:
	$(xCC_EXAMPLE) examples/line_area.c -o ./build/sparks-line-area

example-line:
	$(xCC_EXAMPLE) -O0 examples/line.c -o ./build/sparks-line

example-area:
	$(xCC_EXAMPLE) -O0 examples/area.c -o ./build/sparks-area
